...
const EditDetails = (props) => {
  const [memberDetails, setMemberDetails] = useState({
    ...
    joiningDate: props.member.joiningDate,
    CV: props.member.CV,
    certification: props.member.certification
  });
  ...
  return (
    <div className="flex justify-center py-8 bg-gray-100">
      <form onSubmit={handleSubmit} className="border border-gray-300 bg-white shadow-md rounded-lg p-8 w-full max-w-4xl">
        ...
        {memberDetails.certification && memberDetails.certification.map((cert, index) => (
          <div key={index} className="mb-6">
            ...
            <div className="mb-4">
              ...
              <input type="text" name="category" value={cert.catogery} onChange={(e) => handleCertificationChange(e, index)} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
            </div>
            <div className="mb-4">
