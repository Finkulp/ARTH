...
export default function PaperTrading() {
  return (
    <>
    <div style={{paddingTop:'150px',background:`url(${cyan})`,backgroundSize:'cover',paddingBottom:'50px'}}>
      ...
      <button type="button" class="text-white bg-blue-100  focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
        ...
        <div style={{fontSize:'23px',fontFamily:"poppins",color:'blue',textAlign:"center",fontWeight:"600"}}>Courses</div>
                ...
                <div style={{width:'50%',fontSize:'18',fontFamily:'poppins',color:'green',marginTop:'30px',textAlign:'center'}}
                 ...
                 data-aos-mirror="true"
                 data-aos-once="false"
                 data-aos-anchor-placement="center" >Explore our comprehensive courses to master the art of trading. Enhance your investment skills and achieve your financial goals with expert guidance.</div>
                </div>
            </div>
            <div>
                <div style={{display:'flex',justifyContent:'center'}}>
        ...
        <div style={{fontSize:'23px',fontFamily:"poppins",color:'blue',textAlign:"center",fontWeight:"600"}}>Easy Payment</div>
                ...
                <div style={{width:'50%',fontSize:'18',fontFamily:'poppins',color:'green',marginTop:'30px',textAlign:'center'}}
                 ...
                 data-aos-mirror="true"
                 data-aos-once="false"
                 data-aos-anchor-placement="center" >You can choose between a full subscription package or a pay-as-you-go option (billed per minute) to use our servers for precise Paper Trading simulations.</div>
                </div>
            </div>
        </div>
    </div>
