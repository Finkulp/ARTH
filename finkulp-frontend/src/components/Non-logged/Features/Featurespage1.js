  ...
  return (
    ...
    <div style={{display:'flex',marginTop:'50px',gap:'100px',marginLeft:'50px'}}>
      ...
      <div style={{marginTop:'50px'}}>
        ...
        <div style={{width:'50%',fontSize:'18',fontFamily:'poppins',color:'green',paddingBottom:'50px',textAlign:'left'}}
         data-aos="fade-left"
         data-aos-offset="50"
         data-aos-delay="50"
         data-aos-duration="1000"
         ...
         data-aos-mirror="true"
         data-aos-once="false"
         data-aos-anchor-placement="center" >Be it Nasdaq or NSE, Indian or global markets, we offer multi-exchange, multi-broker, and multi-country trading modules, all under one roof</div>
        </div>
        </div>
        ...
        <div style={{width:'50%',fontSize:'18',fontFamily:'poppins',color:'green',textAlign:'left',paddingBottom:'50px'}}
         data-aos="fade-left"
         data-aos-offset="50"
         data-aos-delay="50"
         data-aos-duration="1000"
         ...
         data-aos-mirror="true"
         data-aos-once="false"
         data-aos-anchor-placement="center" >From 150+ technical indicators to diverse candlestick patterns to every category of order (Regular, Bracket, Cover, Market, Limit, SL, SL-M) and more, we accommodate for any and every format of trading possible on our platform</div>
        </div>
        </div>
        <div style={{textAlign:'center',display:'flex'}}>
        <button type="button" class="text-white bg-blue-100  focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" style={{height:"45px"}}>
        ...
        <div style={{display:'flex'}}>
        <div style={{width:'50%',fontSize:'18',fontFamily:'poppins',color:'green',paddingRight:'40px',textAlign:'left'}}
         data-aos="fade-left"
         data-aos-offset="50"
         data-aos-delay="50"
         data-aos-duration="1000"
         ...
         data-aos-mirror="true"
         data-aos-once="false"
         data-aos-anchor-placement="center" >You have the option to choose from two payment modules, Pay-as-you-go or buy a Monthly Subscription from us, whatever suits you the best</div>
        </div>
        </div>
        </div>
      </div>
