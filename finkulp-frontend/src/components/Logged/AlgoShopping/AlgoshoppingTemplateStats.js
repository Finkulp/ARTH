    ...
    <section className="pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
      <div className="container mx-auto">
        ...
        <div className=" flex flex-wrap " style={{marginTop:"-50px"}}>
          <TeamCard
             value="Name"
             title={props.Algos.Strategist}
          />
          <TeamCard
              value="Risk Level"
             title={props.Algos.NSE}
          />
          <TeamCard
            value="Benchmark"
            title={props.Algos.Category}
            
          />
          <TeamCard
            value="Earning Potential"
            title={props.Algos.Recommended_Duration}
          />
          <TeamCard
            value="Recommended Duration"
            title={props.Algos.Fee.Subscription}
          />
          <TeamCard
            value="Recommended Duration"
            title={props.Algos.Fee.Pay_as_you_go}
          />
        </div>
      </div>
    </section>
