...
const TradingStrategyTemplateStats = (props) => {
  return (
    <section className="pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
      <div className="container mx-auto">
        ...
        <div className=" flex flex-wrap " style={{marginTop:"-50px"}}>
          ...
          <TeamCard
              value="Risk Level"
             title={props.riskLevel}
          />
          <TeamCard
            value="Benchmark"
            title={props.benchmark}
            
          />
          <TeamCard
            value="Earning Potential"
            title={props.earningPotential}
          />
          <TeamCard
            value="Recommended Duration"
            title={props.recommendedDuration}
          />
        </div>
      </div>
    </section>
...
export default TradingStrategyTemplateStats;
