...
import TradingStrategyTemplateStats from "./TradingStrtegyTemplateStats";
const TradingStrategyTemplateDescription = (props) => {
...
export default TradingStrategyTemplateDescription;
